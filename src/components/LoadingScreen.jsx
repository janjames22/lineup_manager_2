  ...
  return (
    <div className="fixed inset-0 z-[1000] flex flex-col items-center justify-center bg-slate-950">
      <div className="relative mb-8">
        <div className="absolute inset-0 animate-ping rounded-3xl bg-blue-500/20"></div>
        <div className="relative flex size-24 items-center justify-center rounded-[2rem] bg-slate-900 shadow-2xl ring-1 ring-white/10">
      ...
      <div className="flex flex-col items-center gap-2">
        ...
        <div className="flex items-center gap-2 text-blue-400">
          ...
          <span className="text-xs font-black uppercase tracking-[0.2em]">Preparing Workspace...</span>
        </div>
      </div>
